...
void dwmac_dma_start_tx(struct stmmac_priv *priv, void __iomem *ioaddr, u32 chan)
{
...
void dwmac_dma_start_rx(struct stmmac_priv *priv, void __iomem *ioaddr, u32 chan)
{
	u32 value = readl(ioaddr + DMA_CONTROL);
