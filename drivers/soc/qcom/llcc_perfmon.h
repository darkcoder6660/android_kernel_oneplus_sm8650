...
#define LLCC_VER4			(41)
#define LLCC_VER2			(21)
#define LLCC_VER5_1			(51)
#define VER_CHK(v)			(v >= LLCC_VER2) //check LLCC version 2
#define VER_CHK4(v)			(v >= LLCC_VER4) //check LLCC version 4
#define VER_CHK5_1(v)			(v == LLCC_VER5_1) //check LLCC version 5.1

/* COMMON */
#define LLCC_COMMON_HW_INFO(v)	(VER_CHK5_1(v) ? 0x64000 : (VER_CHK(v) ? 0x34000 : 0x30000))
#define LLCC_COMMON_STATUS0(v)	(VER_CHK5_1(v) ? 0x6400C : (VER_CHK(v) ? 0x3400C : 0x3000C))
#define LLCC_COMMON_PROF_FILTERS_FEATURE_CFG	0x64100


/* FEAC */
#define FEAC_PROF_FILTER_CFG_BASE(v) (VER_CHK5_1(v) ? 0x73000 : (VER_CHK(v) ? 0x43000 : 0x037000))
#define FEAC_PROF_FILTER_0_CFG1(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x4)
#define FEAC_PROF_FILTER_0_CFG2(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x8)
#define FEAC_PROF_FILTER_0_CFG3(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0xC)
#define FEAC_PROF_FILTER_0_CFG5(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x14)
#define FEAC_PROF_FILTER_0_CFG6(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x18)
#define FEAC_PROF_FILTER_0_CFG7(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x1C)
#define FEAC_PROF_FILTER_0_CFG6_EXT(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x2C)
#define FEAC_PROF_FILTER_1_CFG1(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x34)
#define FEAC_PROF_FILTER_1_CFG2(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x38)
#define FEAC_PROF_FILTER_1_CFG3(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x3C)
#define FEAC_PROF_FILTER_1_CFG5(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x44)
#define FEAC_PROF_FILTER_1_CFG6(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x48)
#define FEAC_PROF_FILTER_1_CFG7(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x4C)
#define FEAC_PROF_FILTER_1_CFG6_EXT(v)	(FEAC_PROF_FILTER_CFG_BASE(v) + 0x5C)

#define FEAC_PROF_EVENT_n_CFG(v, n)	((FEAC_PROF_FILTER_CFG_BASE(v) + 0x60) + (4 * (n)))
#define FEAC_PROF_CFG_BASE(v) (VER_CHK5_1(v) ? 0x730A0 : (VER_CHK(v) ? 0x430A0 : 0x0370A0))
#define FEAC_PROF_CFG(v)		(FEAC_PROF_CFG_BASE(v))
#define FEAC_PROF_CFG1(v)		(FEAC_PROF_CFG_BASE(v) + 0x4)

/* FERC */
#define FERC_PROF_BASE(v) (VER_CHK5_1(v) ? 0x79000 : (VER_CHK(v) ? 0x49000 : 0x03B000))
#define FERC_PROF_FILTER_0_CFG0(v)	(FERC_PROF_BASE(v))
#define FERC_PROF_FILTER_1_CFG0(v)	(FERC_PROF_BASE(v) + 0x10)
#define FERC_PROF_EVENT_n_CFG(v, n)	((FERC_PROF_BASE(v) + 0x20) + (4 * (n)))
#define FERC_PROF_CFG(v)		(FERC_PROF_BASE(v) + 0x60)

/* FEWC */
#define FEWC_PROF_BASE(v) (VER_CHK5_1(v) ? 0x69000 : (VER_CHK(v) ? 0x39000 : 0x033000))
#define FEWC_PROF_FILTER_0_CFG0(v)	(FEWC_PROF_BASE(v))
#define FEWC_PROF_FILTER_1_CFG0(v)	(FEWC_PROF_BASE(v) + 0x10)
#define FEWC_PROF_EVENT_n_CFG(v, n)	((FEWC_PROF_BASE(v) + 0x20) + (4 * (n)))

/* BEAC */
#define BEAC0_PROF_BASE(v) (VER_CHK5_1(v) ? 0xC1000 : (VER_CHK(v) ? 0x61000 : 0x49000))
#define BEAC0_PROF_FILTER_0_CFG3(v)	(BEAC0_PROF_BASE(v) + 0xC)
#define BEAC0_PROF_FILTER_0_CFG4(v)	(BEAC0_PROF_BASE(v) + 0x10)
#define BEAC0_PROF_FILTER_0_CFG5(v)	(BEAC0_PROF_BASE(v) + 0x14)
#define BEAC0_PROF_FILTER_0_CFG2(v)	(BEAC0_PROF_BASE(v) + 0x08)
#define BEAC0_PROF_FILTER_1_CFG2(v)	(BEAC0_PROF_BASE(v) + 0x28)
#define BEAC0_PROF_FILTER_1_CFG3(v)	(BEAC0_PROF_BASE(v) + 0x2C)
#define BEAC0_PROF_FILTER_1_CFG4(v)	(BEAC0_PROF_BASE(v) + 0x30)
#define BEAC0_PROF_FILTER_1_CFG5(v)	(BEAC0_PROF_BASE(v) + 0x34)
#define BEAC0_PROF_EVENT_n_CFG(v, n)	((BEAC0_PROF_BASE(v) + 0x40) + (4 * (n)))
#define BEAC0_PROF_CFG(v)		(BEAC0_PROF_BASE(v) + 0x80)
#define BEAC0_PROF_CFG0(v)		(BEAC0_PROF_BASE(v) + 0x88)
#define BEAC0_PROF_CFG1(v)		(BEAC0_PROF_BASE(v) + 0x8C)
#define BEAC_INST_OFF			(0x4000)

/* BERC */
#define BERC_PROF_BASE(v) (VER_CHK5_1(v) ? 0x6D000 : (VER_CHK(v) ? 0x3D000 : 0x039000))
#define BERC_PROF_FILTER_0_CFG0(v)	(BERC_PROF_BASE(v))
#define BERC_PROF_FILTER_1_CFG0(v)	(BERC_PROF_BASE(v) + 0x10)
#define BERC_PROF_EVENT_n_CFG(v, n)	((BERC_PROF_BASE(v) + 0x20) + (4 * (n)))
#define BERC_PROF_CFG(v)		(BERC_PROF_BASE(v) + 0x60)

/* TRP */
#define TRP_PROF_BASE(v)			(VER_CHK5_1(v) ? 0x48000:0x024000)
#define TRP_PROF_FILTER_0_CFG1(v)		(TRP_PROF_BASE(v) + 0x4)
#define TRP_PROF_FILTER_0_CFG2(v)		(TRP_PROF_BASE(v) + 0x8)
#define TRP_PROF_FILTER_0_CFG2_EXT(v)		(TRP_PROF_BASE(v) + 0x120)
#define TRP_PROF_FILTER_1_CFG1(v)		(TRP_PROF_BASE(v) + 0x14)
#define TRP_PROF_FILTER_1_CFG2(v)		(TRP_PROF_BASE(v) + 0x18)
#define TRP_PROF_FILTER_1_CFG2_EXT(v)		(TRP_PROF_BASE(v) + 0x130)
#define TRP_PROF_EVENT_n_CFG(v, n)		((VER_CHK5_1(v) ? 0x48020:0x024020) + (4 * (n)))
#define TRP_SCID_n_STATUS(n)		(0x00004 + 0x1000 * (n))
#define TRP_SCID_n_STATUS1(n)		(0x0001C + 0x1000 * (n))
#define TRP_CAP_COUNTERS_DUMP_CFG(v)	(VER_CHK5_1(v) ? 0x452A4:0x2332C)

/* DRP */
#define DRP_PROF_BASE(v)		(VER_CHK5_1(v) ? 0x81000 : (VER_CHK(v)\
						 ? 0x51000 : 0x044000))
#define DRP_PROF_EVENT_n_CFG(v, n)	((DRP_PROF_BASE(v) + 0x10) + (4 * (n)))
#define DRP_PROF_CFG(v)			(DRP_PROF_BASE(v) + 0x50)

/* PMGR */
#define PMGR_PROF_EVENT_n_CFG(v, n)	((VER_CHK5_1(v) ? 0x7D000 : (VER_CHK(v) ?\
						 0x4D000 : 0x03F000)) + (4 * (n)))

#define PERFMON_BASE(v)			(VER_CHK5_1(v) ? 0x66000 : (VER_CHK(v) ?\
						 0x36000 : 0x031000))
...
#define PERFMON_DUMP(v)			(VER_CHK5_1(v) ? 0x67000 : (VER_CHK4(v) ? 0x37000 :\
						 (VER_CHK(v) ? 0x36010 : 0x031010)))

#define LLCC_COUNTER_n_VALUE(v, n)	((VER_CHK5_1(v) ? 0x67008 : (VER_CHK4(v) ? 0x37008 :\
						 (VER_CHK(v) ? 0x36060 : 0x31060))) + (4 * (n)))

#define EVENT_NUM_MAX			(128)
#define SCID_MAX(v)			(VER_CHK5_1(v)?(64):(32))
...
#define LLCC_PROF_FILTERS_LEGACY_MODE	(0x0)
...
#define TRP_SCID_STATUS_CURRENT_CAP_MASK(v)	GENMASK(TRP_SCID_STATUS_CURRENT_CAP_SHIFT +\
						(VER_CHK5_1(v) ? 15 : 14),\
						TRP_SCID_STATUS_CURRENT_CAP_SHIFT)
#define TRP_SCID_STATUS1_CURRENT_CAP_MASK	GENMASK(TRP_SCID_MATCH_SHIFT + 18,\
...
#define LLCC_VERSION_5_1		(0x05010000)
